...
public class UserOwnBooksUI {
	...
	public UserOwnBooksUI(Controller controller, RegistredUser user) {
		this.user = user;
		...
		lblMeusLivros.setBounds(22, 46, 194, 23);
	...
	private void selectBook(Controller controller) {
		controller.setOwnBookToTrade(bookList.get(list.getSelectedIndex()));
